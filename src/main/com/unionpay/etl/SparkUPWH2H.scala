    ...
    DateUtils.timeCost("JOB_HV_4") {
      ...
      val results = sqlContext.sql(
        s"""
           ...
           |on trim(ta.trans_tfr_tm)=trim(tb.trans_tfr_tm) and trim(ta.sys_tra_no)=trim(tb.sys_tra_no) and lpad(trim(ta.acpt_ins_id_cd),11,'0')=lpad(trim(tb.acpt_ins_id_cd),11,'0') and lpad(trim(ta.fwd_ins_id_cd),11,'0')=lpad(trim(tb.fwd_ins_id_cd),11,'0')
           ...
           |)td
           |on trim(ta.trans_tfr_tm)=trim(td.trans_tfr_tm) and trim(ta.sys_tra_no)=trim(td.sys_tra_no) and lpad(trim(ta.acpt_ins_id_cd),11,'0')=lpad(trim(td.acpt_ins_id_cd),11,'0') and lpad(trim(ta.fwd_ins_id_cd),11,'0')=lpad(trim(td.fwd_ins_id_cd),11,'0')
           |
           |left join
